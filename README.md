...
Here, we can see that by the jet stream area, we can probably save more than a thousand usd by using A350-900 rather than without this jet stream area. A350-900 requires only 88067 usd, while in task1 scenario one it would ask us for 91000 usd for carrying all passengers! Furthemore, A321neo is still not viable for this route.
